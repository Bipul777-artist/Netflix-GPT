...
export const {addNowPlayingMovies, movieTrailers, addTopRatedSeries, addPopularMovies, addContent, addMovieYoutubeKey, addContentKey , addHoveredContent, clearNowPlayingMovies} = movieSlice.actions;
